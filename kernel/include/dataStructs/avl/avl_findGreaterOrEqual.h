#ifndef PhiOS_DATA_STRUCTURES_AVL_FIND_GREATER_OR_EQUAL
#define PhiOS_DATA_STRUCTURES_AVL_FIND_GREATER_OR_EQUAL
...
#endif // end if PhiOS_DATA_STRUCTURES_AVL_FIND_GREATER_OR_EQUAL
