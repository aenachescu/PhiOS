#ifndef CLIB_TEMPLATE_DATA_STRUCTURES_AVL_NODE_FIND_GREATER_OR_EQUAL
#define CLIB_TEMPLATE_DATA_STRUCTURES_AVL_NODE_FIND_GREATER_OR_EQUAL
...
#endif // end if CLIB_TEMPLATE_DATA_STRUCTURES_AVL_NODE_FIND_GREATER_OR_EQUAL
